...
model = dict(
    ...
    disc=dict(type="GLDiscs", global_disc_cfg=global_disc_cfg, local_disc_cfg=local_disc_cfg),
    loss_gan=dict(
        type="GANLoss",
        gan_type="vanilla",
        loss_weight=0.001,
...
train_cfg = dict(disc_step=1, start_iter=0, iter_tc=2, iter_td=3, local_size=(128, 128))
test_cfg = dict()
