...
def test_basicvsr_model():
    ...
    model_cfg = dict(
        type="BasicVSR",
        generator=dict(type="BasicVSRNet", mid_channels=64, num_blocks=30, spynet_pretrained=None),
    ...
    data_batch = {"lq": inputs, "gt": targets, "meta": [{"gt_path": "fake_path/fake_name.png", "key": "000"}]}
