...
def test_basic_restorer():
    model_cfg = dict(
        type="BasicRestorer",
        generator=dict(type="MSRResNet", in_channels=3, out_channels=3, mid_channels=4, num_blocks=1, upscale_factor=4),
    ...
    data_batch = {"lq": inputs, "gt": targets, "meta": [{"lq_path": "fake_path/fake_name.png"}]}
