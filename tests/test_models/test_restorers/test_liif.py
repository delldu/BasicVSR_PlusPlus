...
def test_liif():
    ...
    optimizer = obj_from_dict(optim_cfg, torch.optim, dict(params=restorer.parameters()))
    ...
    if torch.cuda.is_available():
        ...
        data_batch = {"lq": inputs.cuda(), "gt": targets.cuda(), "coord": coord.cuda(), "cell": cell.cuda()}
