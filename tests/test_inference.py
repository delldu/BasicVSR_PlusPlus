...
from mmedit.apis import init_model, restoration_video_inference, video_interpolation_inference
...
def test_video_interpolation_inference():
    ...
    model.cfg["demo_pipeline"] = [
        dict(type="LoadImageFromFileList", io_backend="disk", key="inputs", channel_order="rgb"),
