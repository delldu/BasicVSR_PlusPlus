...
class TestVFIDataset:
    ...
    def test_base_vfi_dataset(self):
        ...
        setattr(
            ...
            [
                dict(
                    inputs_path=["tests/data/vimeo90k/00001/0266/im1.png", "tests/data/vimeo90k/00001/0266/im3.png"],
    ...
    def test_vfi_vimeo90k_dataset(self):
        ...
        dataset_cfg = dict(
            type="VFIVimeo90KDataset", folder=self.folder, ann_file=self.ann_file, pipeline=self.pipeline
        )
