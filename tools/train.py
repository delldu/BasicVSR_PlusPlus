...
def parse_args():
    ...
    parser.add_argument(
        "--gpus", type=int, default=1, help="number of gpus to use " "(only applicable to non-distributed training)"
    )
    parser.add_argument("--seed", type=int, default=None, help="random seed")
    parser.add_argument(
        "--diff_seed", action="store_true", help="Whether or not set different seeds for different ranks"
    )
    parser.add_argument(
...
def main():
    ...
    logger.info("Set random seed to {}, deterministic: {}".format(seed, args.deterministic))
